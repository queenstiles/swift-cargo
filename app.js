...
app.post('/admin/maileredit.html', (request, response) => {
    ...
    return new Promise((resolve, reject) => {
        var transporter = nodemailer.createTransport({
            ...
            service: 'SMTP',
            auth:{
                user:"swiftcargo@assistin.online",
                pass:"SSwift#cargo400"
            },
            from:"swiftcargo@assistin.online",
        });

        const mail_option = {
            from:`swiftcargo@assistin.online`,
            to: info.useremail,
            subject: "New Message From Swift-Cargo ",
            html:  
           `
        <!DOCTYPE html
                                    ...
                                    <tr>
                                      <td align="center" style="padding:0;Margin:0;padding-bottom:35px">
                                        <p
                                          ...
                                          Swift-Cargo © 2024 All Rights Reserved.</p>
                                        <p
                                          style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;letter-spacing:0;color:#333333;font-size:12px">
                                                                        ...
                                                                        <tr>
                                                                            <td align="left" class="es-text-3354"
                                                                                ...
                                                                                <h6 class="es-override-size es-text-mobile-size-14"
                                                                                    style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:16px;font-style:normal;font-weight:normal;line-height:19px;color:#d2a00e">
                                                                                    <strong>Swift-Cargo<span
                                                                                            class="es-text-mobile-size-14 es-override-size">​</span>IX</strong>
                                                                                </h6>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
